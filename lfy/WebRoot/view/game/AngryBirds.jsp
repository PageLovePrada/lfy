...
<html>
  <head>
	...
	<style type="text/css">
		html{
				background: url(./common/img/game/AngryBirds/background.jpg) bottom center no-repeat #efeff4 ;
		}
		* {
			margin: 0px;
			padding: 0px;
...
<script type="text/javascript" src="././common/js/AngryBirds.phaser.min.js" ></script>
<script>
...
game.States.boot = function() {
    this.preload = function() {
        ...
        game.load.image('loading', './common/img/game/AngryBirds/preloader.gif');
    };
...
game.States.preload = function() {
    this.preload = function() {
        ...
        game.load.image('background', './common/img/game/AngryBirds/background.png');
        game.load.image('ground', './common/img/game/AngryBirds/ground.png');
        game.load.image('title', './common/img/game/AngryBirds/title.png');
        game.load.spritesheet('bird', './common/img/game/AngryBirds/bird.png', 34, 24, 3);
        game.load.image('btn', './common/img/game/AngryBirds/start-button.png');
        game.load.spritesheet('pipe', './common/img/game/AngryBirds/pipes.png', 54, 320, 2);
        game.load.bitmapFont('flappy_font', './common/img/game/AngryBirds/fonts/flappyfont/flappyfont.png', './common/img/game/AngryBirds/fonts/flappyfont/flappyfont.fnt');
        game.load.audio('fly_sound', './common/img/game/AngryBirds/flap.wav');
        game.load.audio('score_sound', './common/img/game/AngryBirds/score.wav');
        game.load.audio('hit_pipe_sound', './common/img/game/AngryBirds/pipe-hit.wav');
        game.load.audio('hit_ground_sound', './common/img/game/AngryBirds/ouch.wav');
        game.load.image('ready_text', './common/img/game/AngryBirds/get-ready.png');
        game.load.image('play_tip', './common/img/game/AngryBirds/instructions.png');
        game.load.image('game_over', './common/img/game/AngryBirds/gameover.png');
        game.load.image('score_board', './common/img/game/AngryBirds/scoreboard.png');
    };
    this.create = function() {
